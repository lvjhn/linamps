...
# --- INSTALL DNS MASQ
cecho bright_green --bold "# Installing DNSMasq..."
apk add dnsmasq=2.91-r0

# --- INSTALL MICRO
cecho bright_green --bold "# Installing Micro editor..."
apk add micro=2.0.14-r6

# --- INSTALL PYTHON
cecho bright_green --bold "# Installing Python..."
apk add python3=3.12.11-r0 py3-pip=25.1.1-r0

# --- CREATE VIRTUAL ENVIRONMENT IN NS/ FOLDER 
cecho bright_green --bold "# Creating virtual environment..."
